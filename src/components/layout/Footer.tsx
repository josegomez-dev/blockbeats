import styles from '@/app/assets/styles/layouts/Footer.module.css'
  ...
  return (
    <footer className={styles.footer}>
      ...
      <Link href={'/blockbeats-whitepaper.pdf'} target={'_blank'}>
        <Image src={'/images/logos/logo.webp'} alt={'metamask'} width={100} height={100} style={{ marginBottom: '-20px' }} />
      </Link>
      <br />
      <br />
